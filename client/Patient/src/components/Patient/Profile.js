                ...
                <Row style={{margin:'auto',marginTop:'4px'}}>
                    ...
                    <Col  sm='12' md='4' lg='3' xl='3' style={{margin:'auto',float:'right',border:'3px solid #11517F',height:'500px',borderRadius:'50px',textAlign:'center',borderBottom:'none',borderTop:'none'}}  className='container'>
                        ...
                        <Form>
                            ...
                            <input type='number' placeholder='old phone number' className='formInput' style={formInput}/>
                            <input type='number' placeholder='new phone number' className='formInput'  style={formInput}/><br></br>
                        ...
                        <span><p style={{fontWeight:'bold'}}>Change password:</p></span>
                            <input type='password' placeholder='old password' className='formInput' style={formInput}/>
                            <input type='password' placeholder='new password' className='formInput'  style={formInput}/><br></br>
