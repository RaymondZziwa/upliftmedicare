            ...
            <div className='bg'>
                ...
                <Row style={{margin:'auto',marginTop:'4px'}}>
                    <Col sm='12' md='12' lg='12' xl='12' className='navbar'>
                        ...
                        <Link to='/AppointmentHistory'><div className='parentdiv' style={linkParent}><p className='linkattr active' style={link}>Appointment History</p></div></Link>
                    ...
                    <Col  sm='12' md='7' lg='7' xl='7' style={{margin:'auto',float:'right',border:'3px solid #11517F',borderRadius:'50px',textAlign:'center',borderBottom:'none',borderTop:'none'}}  className='container'>
                        <h5 style={headings}>Appointment History</h5>
